...
export const Route = createFileRoute("/colecao")({
  ...
  head: () => ({
    meta: [
      { title: "Coleção completa — ACHAEBUSCA" },
      {
        name: "description",
        content:
          "Explore a coleção completa de roupas e calçados no atacado da ACHAEBUSCA com filtros e ordenação.",
      },
      { property: "og:title", content: "Coleção completa — ACHAEBUSCA" },
      {
        property: "og:description",
        content: "Catálogo completo com filtros por categoria, preço e novidades.",
      },
    ],
  }),
...
function ColecaoPage() {
  ...
  const subheading = q
    ...
    : "Todo o catálogo em um só lugar. Use os filtros para refinar.";
      ...
      <section className="relative overflow-hidden border-b border-border bg-card">
        <div className="relative mx-auto max-w-7xl px-4 py-8 md:py-12">
          <div className="relative flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-primary">
            ...
            {q ? "Busca" : activeSlug ? "Categoria" : "Catálogo completo"}
          </div>
